...
const searchField = document.querySelector('#search');
  ...
  searchField.addEventListener('input', (e) => {
    ...
    const searchResults = companies.filter(company => {
        return company.city.toLowerCase().includes(e.target.value.toLowerCase()) || company.company.toLowerCase().includes(e.target.value.toLowerCase());
    });
    ...
    searchResults.forEach((element, i) => {
        ...
        r.onclick = function () {
            ...
            var long = json_obj['results'][0]['geometry']['location']['lng'];
            ...
            var companydetails = document.getElementById("companyname");
            companydetails.classList.remove("hidden");
            companydetails.innerHTML = `<h2><b>${element.company}</b></h2>
                                        <p><b>Location:</b> ${element.city}, ${element.state}</p>
                                        <p><b>Website:</b> ${element.Website}</p>
                                        <p><b>Sector:</b> ${element.sector}</p>
                                        <p><b>CEO:</b> ${element.CEO}</p>
                                        <p><b># of Employees:</b> ${element.num_of_employees}</p>
                                        <p><b>Rank:</b> ${element.rank}</p>
                                        <p><b>Ticker:</b> ${element.Ticker}</p>
                                        <p><b>Revenue:</b> ${element.revenue}</p>
                                        <p><b>Profit:</b> ${element.profit}</p>
                                        <p><b>Market Cap:</b> ${element.market_cap}</p>`
